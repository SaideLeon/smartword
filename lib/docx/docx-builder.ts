...
async function buildBlock(node: DocumentNode, options: IParagraphOptions = {}): Promise<any> {
  switch (node.type) {
    ...
    case 'heading': {
      // Gerar os runs com bold activado desde o início
      ...
      // Forçar cor preta (000000) em todos os TextRun — sobrepõe o azul do estilo Word
  ...
  return new Document({
    styles: {
      ...
      paragraphStyles: [
        ...
        // Sobrepor a cor azul dos estilos de cabeçalho predefinidos do Word
        {
          id: 'Heading1',
          name: 'Heading 1',
          basedOn: 'Normal',
