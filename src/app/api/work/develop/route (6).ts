...
// ─────────────────────────────────────────────────────────────────────────────
// getSectionInstruction — Instruções específicas por secção
//
// Cada secção tem:
//   1. TAREFA CLARA — o que gerar exactamente
//   2. EXEMPLO DE ERRO REAL — o que nunca deve aparecer (retirado de trabalhos reais)
//   3. EXEMPLO CORRECTO — o formato esperado
//   4. PROIBIÇÕES ABSOLUTAS — regras invioláveis
// ─────────────────────────────────────────────────────────────────────────────
