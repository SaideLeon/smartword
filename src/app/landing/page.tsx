  ...
  return (
    <nav>
      <div className="nav-logo">
        ...
        <span className="nav-name">Muneri</span>
      </div>
      ...
      <div className="nav-right">
        <button type="button" className="nav-theme-toggle" onClick={onToggleTheme} aria-label={themeMode === 'dark' ? 'Mudar para modo claro' : 'Mudar para modo escuro'}>
        ...
        <div className="hero-mockup">
          ...
          <div className="phone-frame">
            <div className="phone-header">
              ...
              <span className="phone-logo-text">Muneri</span>
            </div>
...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <main className="landing-page-root" data-theme={themeMode}>
        ...
        <footer>
          <div className="footer-left">Muneri · Markdown para Word com Equações Nativas · 2026</div>
          <div className="footer-right">feito com ∂ em Quelimane, Moçambique</div>
        </footer>
      </main>

      <style jsx global>{`
        :root { --ink:#0f0e0d;--parchment:#f5f0e8;--gold:#c9a96e;--gold2:#8b6914;--shadow:#1e1a14;--muted:#6b6254;--faint:#c4b8a4;--green:#4a7c59;--teal:#3a8a7a;--border:#d8ceb8;--navBg:rgba(245,240,232,.88);--heroRight:#1e1a14;--ctaMark:rgba(0,0,0,.025); }
        [data-theme='dark'] { --ink:#f1e8da;--parchment:#0f0e0d;--gold:#d4b37b;--gold2:#a8832f;--shadow:#080808;--muted:#b0a692;--faint:#6c6459;--green:#6ea886;--teal:#61aa9d;--border:#2c2721;--navBg:rgba(15,14,13,.9);--heroRight:#090908;--ctaMark:rgba(255,255,255,.04); }
        *,:before,:after{box-sizing:border-box;margin:0;padding:0;} html{scroll-behavior:smooth;}
        ...
        nav{position:fixed;top:0;left:0;right:0;z-index:50;display:flex;align-items:center;justify-content:space-between;padding:1.25rem 3rem;background:var(--navBg);backdrop-filter:blur(12px);border-bottom:1px solid var(--border);animation:fadeDown .8s ease both}.nav-logo{display:flex;align-items:center;gap:.65rem}.nav-icon{width:30px;height:30px;background:linear-gradient(135deg,var(--gold) 0%,var(--gold2) 100%);border-radius:5px;display:flex;align-items:center;justify-content:center;font-family:'DM Mono',monospace;font-size:13px;font-weight:700;color:#0f0e0d}.nav-name{font-family:'Playfair Display',serif;font-style:italic;font-size:18px;color:var(--gold2);letter-spacing:.02em}.nav-links{display:flex;gap:2rem;list-style:none;font-family:'DM Mono',monospace;font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:var(--muted)}.nav-links a{color:inherit;text-decoration:none;transition:color .2s}.nav-links a:hover{color:var(--gold2)}.nav-right{display:flex;align-items:center;gap:.6rem}.nav-theme-toggle{border:1px solid var(--border);background:transparent;color:var(--muted);font-family:'DM Mono',monospace;font-size:10px;letter-spacing:.08em;text-transform:uppercase;padding:7px 10px;border-radius:3px;cursor:none;transition:color .2s,border-color .2s,transform .15s}.nav-theme-toggle:hover{color:var(--gold2);border-color:var(--gold2);transform:translateY(-1px)}.nav-cta{background:var(--ink);color:var(--parchment);font-family:'DM Mono',monospace;font-size:11px;letter-spacing:.1em;text-transform:uppercase;padding:8px 20px;border:none;border-radius:3px;cursor:none;text-decoration:none;transition:background .2s,transform .15s;display:inline-block}.nav-cta:hover{background:var(--gold2);transform:translateY(-1px)}
