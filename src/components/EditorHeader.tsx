...
export function EditorHeader({
  ...
  return (
    <header className="relative z-20 flex h-[44px] shrink-0 items-center gap-2 border-b border-[var(--border)] bg-[var(--surface)] px-2.5">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div className="flex flex-col leading-none">
          ...
          <span className="max-w-[150px] overflow-hidden text-ellipsis whitespace-nowrap font-mono text-[9px] text-[var(--dim)]">
      ...
      {/* Status indicators */}
      <span className="font-mono text-[9px] tracking-[.06em] text-[var(--dim)]">LATEX → OMML</span>
      <div className="h-1.5 w-1.5 rounded-full bg-[var(--teal)] shadow-[0_0_5px_var(--teal)]" />
